...
class TestResolveBasic:
    ...
    def test_overlap_keeps_longest(self):
        ...
        outer = Span(
            start=0, end=20, entity_type="ORGANIZATION", text="x" * 20, score=0.5
        )
        inner = Span(start=5, end=10, entity_type="PERSON", text="y" * 5, score=0.9)
    ...
    def test_same_length_higher_score_wins(self):
        ...
        b = Span(start=0, end=5, entity_type="ORGANIZATION", text="Alice", score=0.9)
